    ...
    <div class="index">
        <v-card class="mx-auto">
            ...
            <v-card-text>
                <div class="pt-3 body-1">
                    cFos is one of the most widely studied immediate early genes
                    in the field of neuroscience, which are expressed very soon
                    after different stimuli. By using in situ hybridization and
                    immunostaining technology, the mRNA and protein product of
                    cFos can be identified respectively. In the fast-developing
                    field of brain science, scientists desire to better
                    understand functional meanings of neurons, cFos mapping has
                    become an important approach to assess neuronal activation
                    and determine neuronal circuits underlying stimuli-elicited
                    behaviors. Currently, there does not exist a systematic
                    database focusing on cFos in neuroscience. Our database
                    cFos-ANAB can serve as a helpful tool and good reference for
        ...
        <v-card class="mx-auto mt-12">
            ...
            <v-list-item>
                ...
                <v-list-item-content>
                    <p class="pStyle">
                        cFos-ANAB (1.0) is a user-friendly interface tool for
                        exploring activated CNS neurons and associated behaviors
                        based on cFos expression. 398 nuclei and subnuclei in
                        total associated to 5 behaviors ( pain, feeding, fear,
                        aggression, and sexual behavior ) of rats and mice are
                        provided for quick analyses before experimental designs,
                        more than 1900 records in total are available online.
                    </p>
                </v-list-item-content>
            </v-list-item>
            <v-list-item>
                ...
                <v-list-item-content>
                    <p class="pStyle">
                        All data used in the cFos-ANAB (1.0) are manually
                        extracted from publications of original experiments.  In
                        order to ensure the high quality of data provided by
                        cFos-ANAB, we employ a distinct criterion for data being
                        included in the project, that is, only the results
                        supported by figure legends are focused, of which cFos
                        positive expression with significant statistics are
                        required.  Moreover, data in each record is linked to
                        the DOI of original publication.
                    </p>
                </v-list-item-content>
            </v-list-item>
        </v-card>
        ...
        <v-timeline dense class="mt-12">
            <v-timeline-item small color="secondary lighten-2">
                <v-card class="elevation-2">
                    <v-card-title class="headline">Current Data Version 20210712</v-card-title>
                    <v-list-item three-line>
                        <v-list-item-content>
                            <v-list-item-title>403 Nuclei and subnuclei</v-list-item-title>
